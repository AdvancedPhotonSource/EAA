...
class NNRegistration(BaseTool):
    ...
    image size.
    The offset convention matches :class:`~eaa_imaging.tool.imaging.registration.ImageRegistration`:
    ...
    def get_offset(self, target: Literal["previous", "initial"] = "initial") -> np.ndarray:
        ...
        np.ndarray
            ...
            :meth:`~eaa_imaging.tool.imaging.registration.ImageRegistration.register_images`:
