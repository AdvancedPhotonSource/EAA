        ...
        *args, **kwargs
        ...
        if initial_prompt is None:
            ...
            initial_prompt = render_prompt_template(
                ...
                "focusing.md",
                {
                    "REFERENCE_IMAGE_PROMPTS": reference_image_prompts,
                    "FEATURE_TEXT_DESCRIPTION": feature_text_description,
                    "SUGGESTED_2D_SCAN_KWARGS": suggested_2d_scan_kwargs,
                    "LINE_SCAN_STEP_SIZE_PROMPT": line_scan_step_size_prompt,
                    "INITIAL_PARAMETERS": self.initial_parameters,
                    "REGISTRATION_PROMPT": registration_prompt,
                    "LINE_SCAN_POSITIONING_PROMPT": line_scan_positioning_prompt,
                    "PARAM_STEP_SIZE_PROMPT": parameter_step_size_prompt,
                },
            )
