...
- If a selected skill references supporting files, inspect them yourself with available shell and filesystem tools such as `bash_coding` and `read_file`. Skill directories are approved read locations.
